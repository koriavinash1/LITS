...
tf.app.flags.DEFINE_string('train_dir', "/media/brats/Varghese/lits2017/NewDataSet/train/",
...
tf.app.flags.DEFINE_integer('denseBlockDepth', 2,
		"""Number of DenseBlocks in up & down sampling.""")

tf.app.flags.DEFINE_integer('eval_interval', 80,
